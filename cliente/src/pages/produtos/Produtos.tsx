...
const Produtos = () => {
  ...
  const handleEditarProduto: MaterialReactTableProps<Produto>["onEditingRowSave"] = async ({
    exitEditingMode,
    row,
    values,
  }) => {
  ...
  const getCommonEditTextFieldProps = useCallback(
    (cell: MRT_Cell<Produto>): MRT_ColumnDef<Produto>["muiTableBodyCellEditTextFieldProps"] => {
      return {
...
export const ModalCriarProduto = ({ open, columns, onClose, onSubmit }: CreateModalProps) => {
