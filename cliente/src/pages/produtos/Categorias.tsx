...
const Categorias = () => {
  ...
  const handleSaveRowEdits: MaterialReactTableProps<Categoria>["onEditingRowSave"] = async ({
    exitEditingMode,
    row,
    values,
  }) => {
  ...
  const getCommonEditTextFieldProps = useCallback(
    (cell: MRT_Cell<Categoria>): MRT_ColumnDef<Categoria>["muiTableBodyCellEditTextFieldProps"] => {
      return {
...
export const ModalCriarCategoria = ({ open, columns, onClose, onSubmit }: CreateModalProps) => {
