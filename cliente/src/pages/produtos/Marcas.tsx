...
const Marcas = () => {
  ...
  const handleSaveRowEdits: MaterialReactTableProps<Marca>["onEditingRowSave"] = async ({
    exitEditingMode,
    row,
    values,
  }) => {
  ...
  const getCommonEditTextFieldProps = useCallback(
    (cell: MRT_Cell<Marca>): MRT_ColumnDef<Marca>["muiTableBodyCellEditTextFieldProps"] => {
      return {
...
export const ModalCriarMarca = ({ open, columns, onClose, onSubmit }: CreateModalProps) => {
